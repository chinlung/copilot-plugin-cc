...
Use these as starting templates for Copilot task prompts.
...
```xml
<task>
Diagnose why this existing prompt is underperforming and propose the smallest high-leverage changes to improve it for Copilot.
</task>
