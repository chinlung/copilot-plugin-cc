...
Use these blocks selectively when composing Copilot prompts.
...
Use when Copilot should act without asking routine questions.
...
Use when Copilot might otherwise guess.
